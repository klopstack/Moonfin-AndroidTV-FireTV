 ...
 * It will look for a environment variable called FLICKPICKLE_VERSION first.
 * Next it will look for a property called "flickpickle.version" and lastly it will use the fallback.
...
fun Project.getVersionName(fallback: String = "0.0.0-dev.1") =
	getProperty("flickpickle.version")
		?.removePrefix("v")
		?: fallback
